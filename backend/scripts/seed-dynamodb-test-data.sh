...
aws dynamodb put-item --region "$region" --table-name "$users_table" --item \
  '{"userId":{"S":"TEST#USER#ALICE"},"cognitoSub":{"S":"TEST#SUB#ALICE"},"email":{"S":"alice@dollhouse.test"},"normalizedEmail":{"S":"alice@dollhouse.test"},"searchPartition":{"S":"USER"},"username":{"S":"test-alice"},"normalizedUsername":{"S":"test-alice"},"displayName":{"S":"Test Alice"},"role":{"S":"USER"},"bio":{"S":"Fixture account"},"dollConfiguration":{"M":{"bodyAssetId":{"S":"TEST#ASSET#BODY"},"hairAssetId":{"S":"TEST#ASSET#HAIR"},"eyesAssetId":{"S":"TEST#ASSET#EYES"},"noseAssetId":{"S":"TEST#ASSET#NOSE"},"mouthAssetId":{"S":"TEST#ASSET#MOUTH"},"clothingAssetIds":{"L":[{"S":"TEST#ASSET#SHIRT"}]},"updatedAt":{"S":"2026-08-08T17:00:00Z"}}},"createdAt":{"S":"2026-08-08T16:00:00Z"},"updatedAt":{"S":"2026-08-08T17:00:00Z"}}'
aws dynamodb put-item --region "$region" --table-name "$users_table" --item \
  '{"userId":{"S":"TEST#USER#BOB"},"cognitoSub":{"S":"TEST#SUB#BOB"},"email":{"S":"bob@dollhouse.test"},"normalizedEmail":{"S":"bob@dollhouse.test"},"searchPartition":{"S":"USER"},"username":{"S":"test-bob"},"normalizedUsername":{"S":"test-bob"},"displayName":{"S":"Test Bob"},"role":{"S":"USER"},"currentStatus":{"M":{"status":{"S":"Doing well"},"stress":{"N":"2"},"fatigue":{"NULL":true},"discomfort":{"N":"0"},"updatedAt":{"S":"2026-08-08T17:00:00Z"}}},"createdAt":{"S":"2026-08-08T16:00:00Z"},"updatedAt":{"S":"2026-08-08T17:00:00Z"}}'
aws dynamodb put-item --region "$region" --table-name "$users_table" --item \
  '{"userId":{"S":"TEST#USER#CAROL"},"cognitoSub":{"S":"TEST#SUB#CAROL"},"email":{"S":"carol@dollhouse.test"},"normalizedEmail":{"S":"carol@dollhouse.test"},"searchPartition":{"S":"USER"},"username":{"S":"test-carol"},"normalizedUsername":{"S":"test-carol"},"displayName":{"S":"Test Carol"},"role":{"S":"USER"},"createdAt":{"S":"2026-08-08T16:00:00Z"},"updatedAt":{"S":"2026-08-08T16:00:00Z"}}'
